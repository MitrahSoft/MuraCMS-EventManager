...
component persistent="false" accessors="true" output="false" extends="controller" {
		...
		function save(rc){
			...
			rc.msg= "success:::Tag saved successfully.";
			variables.fw.redirect( action="tag",preserve="msg");
			
		}
		
		function delete(rc){
			Application.termDAO.delete(rc.id);
			rc.msg= "error:::Tag deleted successfully";
			variables.fw.redirect( action="tag",preserve="msg");
		...
		function default (rc){
			rc.qList= Application.termDAO.read(term_type='tag');
		}
}
